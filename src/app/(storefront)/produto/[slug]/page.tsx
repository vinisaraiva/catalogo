    ...
    <div className="space-y-6">
      {coverImage ? (
        <div className="space-y-2">
          <div className="bg-muted border-border/60 relative aspect-square overflow-hidden rounded-xl border">
            <Image
              src={coverImage.url}
              alt={product.name}
              fill
          ...
          {product.product_images.length > 1 ? (
            <div className="hide-scrollbar flex gap-2 overflow-x-auto">
              {product.product_images.map((image) => (
                <div
                  key={image.url}
                  className="bg-muted border-border/60 relative h-16 w-16 shrink-0 overflow-hidden rounded-lg border"
                >
        ...
        <div
          className="bg-muted flex aspect-square items-center justify-center rounded-xl"
          aria-hidden="true"
        >
      ...
      <div className="space-y-2">
        ...
        <h1 className="font-display text-2xl tracking-wide uppercase">{product.name}</h1>
        {product.teams ? (
          <Link
      ...
      {product.description ? (
        <div className="space-y-2">
          <h2 className="font-display text-lg tracking-wide uppercase">Descrição</h2>
      ...
      {related.length > 0 ? (
        <div className="space-y-3">
          <h2 className="font-display text-lg tracking-wide uppercase">Produtos relacionados</h2>
